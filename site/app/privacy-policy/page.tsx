    ...
    <>
      ...
      <section className="bg-[#26303A] py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-5">Have Questions? Contact Us.</h2>
          <p className="text-gray-300 mb-8 leading-relaxed">
            Our team responds quickly. Whether you have a question about this policy or want to learn how ARC can help your agency, reach out.
          </p>
