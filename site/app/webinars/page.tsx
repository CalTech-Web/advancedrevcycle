      ...
      <section className="relative py-20">
        <div className="absolute inset-0 z-0" style={{
          ...
          <svg className="absolute inset-0 w-full h-full opacity-[0.08]" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <pattern id="hex-webinars" x="0" y="0" width="56" height="100" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#hex-webinars)"/>
          </svg>
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="hero-fade-1 text-[#B8EE40] text-sm font-semibold uppercase tracking-widest mb-3">Webinars</p>
